...
/// !`after trimming them`
bool match(String str, String str2, {bool ignoreCase = false}) =>
    str.match(str2, ignoreCase: ignoreCase);
...
/// ! automaticly ignore case sensitivty
bool isNotIn(String str, List<String> list) =>
    list.where((e) => match(str, e, ignoreCase: true)).isEmpty;
